...
| 食材 | 用量 | 切配规格 | 备注 |
| --- | --- | --- | --- |
| 猪肋排 | 400g | 剁段(4-5cm，手指长) | _spec §1，选肥瘦相间肋排 |
| 甜玉米(水果玉米) | 2根 | 剁段(4-5cm，手指长) | _spec §1，甜玉米比糯玉米更适合煮汤 |
| 胡萝卜 | 1根(约200g) | 切滚刀块(3cm见方，麻将牌) | _spec §1 |
| 姜 | 1块 | 切片(2-3mm厚)，5片 | _spec §1 |
| 葱 | 2根 | 切段(4-5cm)，1根垫底1根撒葱花 | _spec §1 |
| 料酒 | 1勺(15ml) | — | 焯水去腥 |
| 盐 | 1小勺(5ml) | — | 出锅前放 |
| 清水 | 6碗(1500ml) | — | — |
...
- **焯水()**：调用 `_spec §6 焯水()`——排骨段冷水下锅，加 COOKING_WINE(1勺料酒)+姜片(2片)，煮开撇去浮沫，捞出用温水冲洗干净。焯水是「编译期优化」，去除血水和骨渣，避免汤浑浊。
...
| 状态测试 | 排骨筷子可轻松插透(_spec §5 肉类熟透)、玉米咬开无硬芯、胡萝卜软糯不糊化、汤面无浮沫 | 筷子插入+品尝 |
